...
class StatsAnalyzer:
    def __init__(self, data_path: str):
        ...
        self.players = {
            "Claquette": {"role": "TOP", "tag": "TSC Claquette"},
            "Spectros": {"role": "JUNGLE", "tag": "TSC Spectros"},
            "Futeyy": {"role": "MID", "tag": "TSC Futeyy"},
            "Tixty": {"role": "ADC", "tag": "TSC Tixty"},
            "Dert": {"role": "SUPPORT", "tag": "TSC Dert"}
        }
    ...
    def get_player_stats(self, player_name: str) -> Dict:
        games = self.load_data()
        player_tag = self.players[player_name]["tag"]
        ...
        for game in games:
            for participant in game['participants']:
                if participant['RIOT_ID_GAME_NAME'] == player_tag:
                    total_games += 1
